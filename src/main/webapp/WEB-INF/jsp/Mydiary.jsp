    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div id="right-sidebar" class="settings-panel">
        ...
        <ul class="nav nav-tabs border-top" id="setting-panel" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="todo-tab" data-toggle="tab" href="#todo-section" role="tab" aria-controls="todo-section" aria-expanded="true">메모</a>
          </li>
         <!--  <li class="nav-item">
            <a class="nav-link" id="chats-tab" data-toggle="tab" href="#chats-section" role="tab" aria-controls="chats-section">CHATS</a>
          </li> -->
        ...
        <div class="tab-content" id="setting-content">
          <div class="tab-pane fade show active scroll-wrapper" id="todo-section" role="tabpanel" aria-labelledby="todo-section">
            <div class="add-items d-flex px-3 mb-0">
              <form class="form w-100">
                <div class="form-group d-flex">
                  <input type="text" class="form-control todo-list-input" placeholder="메모 추가">
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">나의 다이어리</h4>
                  <p class="card-description">
                    다이어리<code><a href="">작성하기</a></code>
                  </p>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>김치찌게 노맛</td>
                          <td>2022/02/04</td>
                          <td><label class="badge badge-danger">맛없음</label></td>
                        </tr>
                        <tr>
                          <td>02</td>
                          <td>김치찌게 그럭저럭</td>
                          <td>2022/02/05</td>
                          <td><label class="badge badge-warning">그냥저냥</label></td>
                        </tr>
                        <tr>
                          <td>03</td>
                          <td>김치찌게 맛있움</td>
                          <td>2022/02/06</td>
                          <td><label class="badge badge-info">맛있음</label></td>
                        </tr>
                        <tr>
                          <td>04</td>
                          <td>김치찌게 너무 맛있움</td>
                          <td>2022/02/06</td>
                          <td><label class="badge badge-success">너무 맛있음</label></td>
                        </tr>                     
                      </tbody>
                    </table>
                  </div>
